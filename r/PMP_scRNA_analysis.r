...
git config --global user.name "sunghwan1234290"
git config --global user.email "sungghwan@gmail.com"
...
mesenchymal_healthy_cells <- FindClusters(mesenchymal_healthy_cells, resolution = 0.05) #0.62 , 0.26
...
mesenchymal_PMP_cells <- FindClusters(mesenchymal_PMP_cells, resolution = 0.1) #0.62 , 0.26
